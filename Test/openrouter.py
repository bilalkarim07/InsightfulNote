...
OUTPUT_DIR = Path("openrouter_results")

TEMPERATURE = 0.7

# Set to True if you only want models that advertise
# free pricing.
...
def test_model(client, model):
    ...
    with open(
        ...
        file.write("=" * 80 + "\n")
        file.write("NEWSROOM OPENROUTER MODEL EVALUATION\n")
        file.write("=" * 80 + "\n\n")
...
def main():
    ...
    print("=" * 70)
    print("NEWSROOM — OPENROUTER MODEL BENCHMARK")
    print("=" * 70)

    print("\nRetrieving OpenRouter model catalog...")

    models = get_testable_models()
